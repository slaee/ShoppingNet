...
$logged_nav_yes = '<nav class="z-depth-0 white">
	<div class="nav-wrapper center" >
		<div class="nav-top-au" >
			<a href="javascript:history.back()" ><i class="material-icons left black-text" style="margin-left:15px;width:23px" >arrow_back_ios</i></a>
		</div>
    </div>
</nav>';
...
?><br>
<div class="container" >
	<span class="h1-sx bd-bd" >Your emails</span>
</div>
<div class="row" >
	<div class="col s12" >
		<ul class="collection">
...
$result = mysqli_query($con,"SELECT * FROM email_notifs WHERE receiver_email='$email'");
while($email_not = mysqli_fetch_array($result)) {
	if($email_not['status'] == "unread"){
	$unread = "#f3f4f5";
	}else {
	$read = "white";
	}
/*	echo '<a href="../../track_booking/'.$email_not['email_token'].'" class="black-text" ><li class="collection-item avatar" style="background:'.$unread.''.$read.'">
	<i class="material-icons circle">person</i>
	<span class="title truncate">'.$email_not['se_title'].'</span>
	<p><span style="font-size:14px" >&mdash; '.$email_not['se_subject'].'</span><br><span class="blue-grey-text" >'.$email_not['sender_email'].'</span></p>
	</li></a>';*/
	echo '<a href="../../track_booking/'.$email_not['email_token'].'" class="black-text" ><li class="collection-item avatar" >
	<i class="material-icons circle">person</i>
	<span class="title truncate">'.$email_not['se_title'].'</span>
	<p><span style="font-size:14px" >&mdash; '.$email_not['se_subject'].'</span><br><span class="blue-grey-text" >'.$email_not['sender_email'].'</span></p>
