...
if(isset($_POST['update_nw']))
{
	...
	// update user data
	$result = mysqli_query($con, "UPDATE user_info SET phone='$phone', address_2='$address_2' WHERE email='$email'");
...
header ("Location: ../../../setup_done_driver/");
}
?>
<!DOCTYPE html>
...
<div class="row" >
	<div class="col s12" >
		<form action="" method="POST" name="set" >
			<span class="md-bd blue-grey-text text-darken-2" >Phone number</span>
			<input type="number" name="phone" class="browser-default input-is" placeholder="+6394744085401" /><br><br>
			
			<span class="md-bd blue-grey-text text-darken-2" >Complete Address</span>
			<textarea type="text" name="address_2" class="input-texta-is" placeholder="#287 Brooklyn St Barangay San Andreas Cebu City 10080" ></textarea><br><br>
			
			<input type="submit" name="update_nw" value="Continue" class="btm-con red lighten-2" />
		</form>
	</div>
</div>
 ...
 $("form[name='set']").validate({
   ...
   messages: {
     phone: {
       ...
       minlength: "Please correct your phone number"
     },
     address_2: {
