...
<div class="product-info" >
	...
	<span class="truncate title blue-grey-text text-darken-4" ><?php echo $row['product']; ?></span>
...
<div class="row" >
	<!--<div class="col s6" >
		<a href="../../../listing_edit2?listing_au=<?php echo $rnd; ?>" class="addcart-btn red lighten-1 hoverable" ><i class="material-icons" >edit </i> Edit</a>	
	</div>-->
	<div class="col s12" >
		<a href="../../../listing_delete?id=<?php echo $rnd; ?>" class="addcart-btn red lighten-1 hoverable" ><i class="material-icons" >delete_outline</i> Delete</a>	
	</div>
</div><br>
<div class="row" >
	...
	<span class="col s12 title_content" ><i class="material-icons" >not_listed_location</i> This item is available only at Cebu City</span><br><br><br>
	...
	echo '<br><span class="col s12 title_desc light" > <b>*</b> This seller not accepting return items</span><br><br>';
	}
	// Faq Content 
	if(empty($FAQ)){
	// Nothing 
