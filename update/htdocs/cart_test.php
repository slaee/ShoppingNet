...
<?php
		...
		$sql = "SELECT SUM(subtotal), SUM(quantity) from cart_order;";
...
<div class="row white" >
	<div class="col s4 item-image" >
		<img src="../../../static/cdn/products_new_rdr/<?php echo $row['image']; ?>" >
	</div>
...
<div class="z-depth-4 nb_btm hide-on-med-only hide-on-large-only" >
	<div class="nav-wrapper" >
    	...
    	<div class="btn z-depth-0 right place-order-au" >
    		Checkout
    	</div>
    </div>
</div>
